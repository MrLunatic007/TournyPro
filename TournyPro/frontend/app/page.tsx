            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                  ...
                  update results, and crown champions.
                </p>
              </div>
            ...
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 border rounded-lg p-6 shadow-sm">
                ...
                <p className="text-sm text-muted-foreground text-center">
                  Automatically generate tournament brackets for 2, 4, 8, or 16 players.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border rounded-lg p-6 shadow-sm">
                <div className="p-3 rounded-full bg-primary/10">
                ...
                <p className="text-sm text-muted-foreground text-center">
                  Track tournament progress with real-time match updates and results.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border rounded-lg p-6 shadow-sm">
                <div className="p-3 rounded-full bg-primary/10">
                ...
                <p className="text-sm text-muted-foreground text-center">
                  Track top performers with our comprehensive leaderboard system.
                </p>
              </div>
            </div>
          </div>
